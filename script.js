...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        top: 20px;
        right: 20px;
        background: ${type === 'success' ? '#27ae60' : type === 'error' ? '#8B0000' : '#B22222'};
        color: white;
        padding: 1rem 1.5rem;
        border-radius: 10px;
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.service-card, .portfolio-item, .stat, .about-content > div');
...
/* 
// Adiciona botão de tema se necessário
